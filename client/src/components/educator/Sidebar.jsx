...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    {name: 'Student Entrolled', path:'/educator/student-entrolled', icon: assets.person_tick_icon},
  ];

  return isEducator && (
    <div className='md:w-64 w-16 border-r min-h-screen text-base borde-gray-500 py-2 flex-flex-col'>
      {menuItems.map((item) => (
